...
with tab1:
    original_title = "<p style='font-family:Calibri; font-size: 20px; font-weight:600;'>Below is link to code which took us from something like this: '£35,000 - £55,000', '£30K–£41K a year', '45–75 an hour', '£200 a day' to what you can see in next tabs. In short, after I got salaries from offers using regular expressions and added what already was in dataframe, I divided data into USD and pound lists, then divided even further to year, day hour etc. . In next step, I took average and how many times specific range occurred. As u see, there were a lot of diffrent formats so I took this approach: If there was range , I took sum of first and second element and dividied it by 2. If not, I just used single value as average. If salary was per hour, I  multiplied it by 2080 (8 hours per day, 260 workdays in year as google says) </p>"
...
with tab4:
    ...
    st.write("At the end there were 102 offers in USD and 120 in pounds and that's strange because most of offers were from US. It looks like in UK, employers more willingly give informations about salary . I decided to make 3 sections with offers from US, from UK and overall.")
    colors = ['r', 'b', 'g']
    fig = plt.figure()
